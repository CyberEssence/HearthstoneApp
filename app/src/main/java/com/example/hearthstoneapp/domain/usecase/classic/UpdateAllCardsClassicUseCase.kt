...
class UpdateAllCardsClassicUseCase @Inject constructor(private val allCardsClassicRepository: AllCardsClassicRepository) {
    suspend fun execute(): List<AllCardsClassic>? =
        allCardsClassicRepository.updateAllCardsClassic()
}