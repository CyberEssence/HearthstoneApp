...
class UpdateAllCardsHallOfFameUseCase @Inject constructor(private val allCardsHallOfFameRepository: AllCardsHallOfFameRepository) {
    suspend fun execute(): List<AllCardsHallOfFame>? =
        allCardsHallOfFameRepository.updateAllCardsHallOfFame()
}